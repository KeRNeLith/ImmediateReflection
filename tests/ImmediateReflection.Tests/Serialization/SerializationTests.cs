...
/// </summary>
[TestFixture]
internal sealed class SerializationTests : ImmediateReflectionTestsBase
{
    #region Test helpers

    [Pure]
    private static T SerializeAndDeserialize<T>(T @object)
    {
    ...
    [Test]
    public static void ImmediatePropertySerialization()
    {
    ...
    [Test]
    public static void ImmediateFieldSerialization()
    {
    ...
    [Test]
    public static void ImmediateTypeSerialization()
    {
