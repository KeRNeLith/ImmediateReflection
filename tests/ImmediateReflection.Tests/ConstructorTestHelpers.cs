...
internal static class ConstructorTestHelpers
{
    ...
    public static void NewParameterLess(Type type, [InstantHandle] Func<object> ctor)
    {
    ...
    public static void NewParamsOnly([InstantHandle] Func<object> ctor, [InstantHandle] Func<object> expectedObject)
    {
        object instance = ctor();
        Assert.IsNotNull(instance);
    ...
    public static void TryNewParameterLess(Type type, bool expectFail, [InstantHandle] TryCtor tryCtor)
    {
    ...
    public static void TryNewParameterLess([InstantHandle] TryCtor tryCtor, [InstantHandle] Func<object> expectedObject)
    {
    ...
    public static void NewWithParameters(Type type, [InstantHandle] ArgsCtor ctor, params object?[] args)
    {
    ...
    public static void TryNewWithParameters(Type type, bool expectFail, [InstantHandle] TryArgsCtor tryCtor, params object?[] args)
    {
    ...
    private static void AssertEqualInstances(Type type, object? other, object? instance)
    {
        if (other is null)
        {
            Assert.IsNull(instance);
    ...
    public static void Copy(Type type, object? other, [InstantHandle] Func<object?, object?> ctor)
    {
    ...
    public static void TryCopy(Type type, object? other, bool expectFail, [InstantHandle] TryCopyCtor tryCtor)
    {
